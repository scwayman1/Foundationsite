...
export const newsPosts: NewsPost[] = [
  {
    ...
    readTime: "3 min read",
    featuredImage: "https://live.staticflickr.com/65535/55213380237_74c1d7141e_b.jpg",
    featuredAlt: "Coastline scholarship banquet at the Fountain Valley location",
    featured: false,
    ...
    galleryImages: [
      {
        ...
        alt: "Guests at the Coastline College Foundation scholarship banquet",
        caption: "The Foundation’s first scholarship banquet brought the Coastline community together in Fountain Valley.",
      },
      {
        src: "https://live.staticflickr.com/65535/55214436388_4506771994_b.jpg",
        alt: "Scholarship banquet moment from the Coastline College Foundation event",
        caption: "The evening created more room for connection, recognition, and shared pride.",
      },
      {
        src: "https://live.staticflickr.com/65535/55214679670_77094f7f1a_b.jpg",
        alt: "Community members gathered for the Coastline College Foundation scholarship banquet",
