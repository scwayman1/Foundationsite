...
export default function CasinoNightAvailability() {
  ...
  async function submit() {
    ...
    setNotice(response.ok ? "Thank you — your availability has been saved." : "Please add your name, email, and at least one available time.");
  }
